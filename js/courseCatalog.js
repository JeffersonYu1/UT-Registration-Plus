...
function updateLinks(course_info, first_name) {
	...
	course_info["links"]["ecis"] = profname ? `https://utdirect.utexas.edu/ctl/ecis/results/search.WBX?&s_in_action_sw=S&s_in_search_type_sw=N&s_in_search_name=${prof_name}%2C%20${first_name}` :
		`https://utdirect.utexas.edu/ctl/ecis/results/search.WBX?s_in_action_sw=S&s_in_search_type_sw=C&s_in_max_nbr_return=10&s_in_search_course_dept=${department}&s_in_search_course_num=${number}`;
}
